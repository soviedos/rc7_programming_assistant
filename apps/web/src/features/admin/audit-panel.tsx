...
const EVENT_TYPE_COLORS: Record<string, string> = {
  ...
  ADMIN_PERMISSION_CREATED: "bg-purple-100 text-purple-800",
  ADMIN_PERMISSION_UPDATED: "bg-purple-100 text-purple-800",
  ADMIN_PERMISSION_DELETED: "bg-red-100 text-red-800",
